...
public class JDBCConnectionExample {
	...
	public static void main(String[] args) {
		...
		try {
			Class.forName("com.mysql.jdbc.Driver");//drivers set is loaded
//			connection = DriverManager.getConnection("jdbc:mysql://localhost/Students", "root", "");//make connection
...
//			print(resultSet2);
	...
	private static void queryAndPrint(Statement st, String query){
		try {
